...
-   sql - если этот параметр установлен в "*true*", помимо сертификатов генерируется файл с расширением "*.sql*", в этом файле находится sql запрос, который добавляет новую таблицу с приватным сертификатом.
