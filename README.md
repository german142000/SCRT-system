...
Как указано выше - существует два Java клиента, идентичных по функционалу. Оба клиента зависят от `JSON Simple` и [`aes-everywhere`](https://github.com/mervick/aes-everywhere/tree/master)https://github.com/mervick/aes-everywhere/tree/master.

- JSON Simple - расшифрованная информация, полученная с клиента.
- aes-everywhere - 
