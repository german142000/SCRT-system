...
- `public boolean getErrorStatus()` - возвращает `true` если в процессе инициализации или работы объекта возникает ошибка, иначе `false`;
...
- что файл по адресу обрабатывает данные с помощью функций "*packs.php*"6
