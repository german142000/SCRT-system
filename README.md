...
- scrt_cert_address - путь к центру сертификации с абсолютным путём к папке "*scrt-system_v4*";
- scrt_host_address - путь к scrt хосчту с абсолютным путём к папке "*scrt-system_v4_host*";
