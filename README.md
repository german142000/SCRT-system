...
Хост сервер и центр сертификации написаны на php. Клиенты написаны на java и js. На языке java существует две версии - для android и версия для остальных приложений, не зависящая от android sdk.
...
системой. PHP должен иметь модуль BCMath для работы с крупными числами.
