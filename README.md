...
Сертификат должен располагаться в базе данных, доступ к которой настраивался в прошлом пункте. Обратите внимание на параметр "*db_name*". Перед загрузкой сертификата вам необходимо создать базу данных с именем, указанном в "*db_name*". После выполнения этих действий,
необходимо выполнить SQL запрос из файла "*private_key.sql*" к созданной базе. После этого хост готов к работе.
